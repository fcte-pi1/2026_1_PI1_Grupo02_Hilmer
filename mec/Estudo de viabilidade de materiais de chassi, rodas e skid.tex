...
\usepackage{booktabs}
\usepackage{url}
\usepackage{helvet}  % Fonte Helvetica (similar à Arial)
\usepackage{indentfirst}

% Configuração de fonte ABNT (Arial/Helvetica)
...
% Espaçamento simples para tabelas e figuras
\usepackage{etoolbox}
\AtBeginEnvironment{table}{\setstretch{1.0}\fontsize{10}{12}\selectfont}
\AtBeginEnvironment{tabular}{\setstretch{1.0}}

% Cabeçalho para numeração de páginas
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\thepage}
