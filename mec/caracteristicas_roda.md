...
A roda interna, que já é moldada para o encaixe com o pneu, é feita de plástico  **ABS** (*Acrilonitrila Butadieno Estireno*), que possui boa durabilidade e resistência, além de sua leveza.

### 2.2. Dimensões

O pneu possui um diâmetro de *30 mm* e largura de *11 mm*. A roda interna, por sua vez, possui diâmetro de *17 mm* e largura de *7 mm*, além de um vão no seu eixo de 
diamêtro *4,5 mm*.
...
![Roda Interna](./desenho%20tecnico/roda/Roda-1.0-Draft-Roda_01.png)
...
![Pneu](./desenho%20tecnico/roda/Roda-1.0-Draft-Pneu_01.png)
...
| :-: | :-: | :-: | :-: | :-: |
| 1.0 | 12/05/2026 | [Eduardo de Pina](https://github.com/eduardodpms) | Criação do documento | - |